...
class TestMakeCXXSeriesInitialization(unittest.TestCase):
    ...
    def test_one_variable(self):
        ...
        target_FORM_code +=    '{42,\{-2\},sector_42_order_n2_numIV,sector_42_order_n2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=        ',get_device_sector_42_order_n2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=    '},{42,\{-1\},sector_42_order_n1_numIV,sector_42_order_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=        ',get_device_sector_42_order_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=    '},{42,\{0\},sector_42_order_0_numIV,sector_42_order_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=        ',get_device_sector_42_order_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=    '},{42,\{1\},sector_42_order_1_numIV,sector_42_order_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=        ',get_device_sector_42_order_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=    '},{42,\{2\},sector_42_order_2_numIV,sector_42_order_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=        ',get_device_sector_42_order_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=    '#endif#@SecDecInternalNewline@#'
    ...
    def test_two_variables(self):
        ...
        target_FORM_code +=       '{8,\{-2,-1\},sector_8_order_n2_n1_numIV,sector_8_order_n2_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n2_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{-2,0\},sector_8_order_n2_0_numIV,sector_8_order_n2_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n2_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{-2,1\},sector_8_order_n2_1_numIV,sector_8_order_n2_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n2_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{-2,2\},sector_8_order_n2_2_numIV,sector_8_order_n2_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n2_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=   '}},true,#@SecDecInternalDblquote@#reg2#@SecDecInternalDblquote@#},'
        target_FORM_code +=   '{-1,2,{'
        target_FORM_code +=       '{8,\{-1,-1\},sector_8_order_n1_n1_numIV,sector_8_order_n1_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n1_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{-1,0\},sector_8_order_n1_0_numIV,sector_8_order_n1_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n1_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{-1,1\},sector_8_order_n1_1_numIV,sector_8_order_n1_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n1_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{-1,2\},sector_8_order_n1_2_numIV,sector_8_order_n1_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_n1_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=   '}},true,#@SecDecInternalDblquote@#reg2#@SecDecInternalDblquote@#},'
        target_FORM_code +=   '{-1,2,{'
        target_FORM_code +=       '{8,\{0,-1\},sector_8_order_0_n1_numIV,sector_8_order_0_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_0_n1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{0,0\},sector_8_order_0_0_numIV,sector_8_order_0_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_0_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{0,1\},sector_8_order_0_1_numIV,sector_8_order_0_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_0_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{8,\{0,2\},sector_8_order_0_2_numIV,sector_8_order_0_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_8_order_0_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=   '}},true,#@SecDecInternalDblquote@#reg2#@SecDecInternalDblquote@#}'
    ...
    def test_three_variables(self):
        ...
        target_FORM_code +=       '{90,\{-1,-3,0\},sector_90_order_n1_n3_0_numIV,sector_90_order_n1_n3_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n3_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{-1,-3,1\},sector_90_order_n1_n3_1_numIV,sector_90_order_n1_n3_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n3_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{-1,-3,2\},sector_90_order_n1_n3_2_numIV,sector_90_order_n1_n3_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n3_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=     '}},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{-1,-2,0\},sector_90_order_n1_n2_0_numIV,sector_90_order_n1_n2_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n2_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{-1,-2,1\},sector_90_order_n1_n2_1_numIV,sector_90_order_n1_n2_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n2_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{-1,-2,2\},sector_90_order_n1_n2_2_numIV,sector_90_order_n1_n2_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n2_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=     '}},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{-1,-1,0\},sector_90_order_n1_n1_0_numIV,sector_90_order_n1_n1_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n1_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{-1,-1,1\},sector_90_order_n1_n1_1_numIV,sector_90_order_n1_n1_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n1_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{-1,-1,2\},sector_90_order_n1_n1_2_numIV,sector_90_order_n1_n1_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_n1_n1_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=     '}},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#}'
        target_FORM_code +=   '},true,#@SecDecInternalDblquote@#b#@SecDecInternalDblquote@#},'
        target_FORM_code +=   '{-3,-1,{'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{0,-3,0\},sector_90_order_0_n3_0_numIV,sector_90_order_0_n3_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n3_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{0,-3,1\},sector_90_order_0_n3_1_numIV,sector_90_order_0_n3_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n3_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{0,-3,2\},sector_90_order_0_n3_2_numIV,sector_90_order_0_n3_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n3_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=     '}},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{0,-2,0\},sector_90_order_0_n2_0_numIV,sector_90_order_0_n2_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n2_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{0,-2,1\},sector_90_order_0_n2_1_numIV,sector_90_order_0_n2_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n2_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{0,-2,2\},sector_90_order_0_n2_2_numIV,sector_90_order_0_n2_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n2_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=     '}},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{0,-1,0\},sector_90_order_0_n1_0_numIV,sector_90_order_0_n1_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n1_0_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{0,-1,1\},sector_90_order_0_n1_1_numIV,sector_90_order_0_n1_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n1_1_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=       '},{90,\{0,-1,2\},sector_90_order_0_n1_2_numIV,sector_90_order_0_n1_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#'
        target_FORM_code +=           ',get_device_sector_90_order_0_n1_2_integrand#@SecDecInternalNewline@#'
        target_FORM_code +=       '#endif#@SecDecInternalNewline@#'
        target_FORM_code +=     '}},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#}'
        target_FORM_code +=   '},true,#@SecDecInternalDblquote@#b#@SecDecInternalDblquote@#}'
    ...
    def test_three_variables_with_contour_deformation(self):
        ...
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n3_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n3_0_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n3_0_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{-1,-3,1\},sector_90_order_n1_n3_1_numIV,sector_90_order_n1_n3_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n3_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n3_1_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n3_1_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{-1,-3,2\},sector_90_order_n1_n3_2_numIV,sector_90_order_n1_n3_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n3_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n3_2_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n3_2_maximal_allowed_deformation_parameters}'
        target_FORM_code +=     '},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{-1,-2,0\},sector_90_order_n1_n2_0_numIV,sector_90_order_n1_n2_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n2_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n2_0_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n2_0_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{-1,-2,1\},sector_90_order_n1_n2_1_numIV,sector_90_order_n1_n2_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n2_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n2_1_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n2_1_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{-1,-2,2\},sector_90_order_n1_n2_2_numIV,sector_90_order_n1_n2_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n2_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n2_2_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n2_2_maximal_allowed_deformation_parameters}'
        target_FORM_code +=     '},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{-1,-1,0\},sector_90_order_n1_n1_0_numIV,sector_90_order_n1_n1_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n1_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n1_0_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n1_0_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{-1,-1,1\},sector_90_order_n1_n1_1_numIV,sector_90_order_n1_n1_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n1_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n1_1_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n1_1_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{-1,-1,2\},sector_90_order_n1_n1_2_numIV,sector_90_order_n1_n1_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_n1_n1_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_n1_n1_2_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_n1_n1_2_maximal_allowed_deformation_parameters}'
        target_FORM_code +=     '},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#}'
        target_FORM_code +=   '},true,#@SecDecInternalDblquote@#b#@SecDecInternalDblquote@#},'
        target_FORM_code +=   '{-3,-1,{'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{0,-3,0\},sector_90_order_0_n3_0_numIV,sector_90_order_0_n3_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n3_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n3_0_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n3_0_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{0,-3,1\},sector_90_order_0_n3_1_numIV,sector_90_order_0_n3_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n3_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n3_1_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n3_1_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{0,-3,2\},sector_90_order_0_n3_2_numIV,sector_90_order_0_n3_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n3_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n3_2_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n3_2_maximal_allowed_deformation_parameters}'
        target_FORM_code +=     '},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{0,-2,0\},sector_90_order_0_n2_0_numIV,sector_90_order_0_n2_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n2_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n2_0_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n2_0_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{0,-2,1\},sector_90_order_0_n2_1_numIV,sector_90_order_0_n2_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n2_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n2_1_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n2_1_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{0,-2,2\},sector_90_order_0_n2_2_numIV,sector_90_order_0_n2_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n2_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n2_2_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n2_2_maximal_allowed_deformation_parameters}'
        target_FORM_code +=     '},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#},'
        target_FORM_code +=     '{0,2,{'
        target_FORM_code +=       '{90,\{0,-1,0\},sector_90_order_0_n1_0_numIV,sector_90_order_0_n1_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n1_0_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n1_0_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n1_0_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{0,-1,1\},sector_90_order_0_n1_1_numIV,sector_90_order_0_n1_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n1_1_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n1_1_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n1_1_maximal_allowed_deformation_parameters},'
        target_FORM_code +=       '{90,\{0,-1,2\},sector_90_order_0_n1_2_numIV,sector_90_order_0_n1_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##ifdef#@SecDecInternalSpace@#SECDEC_WITH_CUDA#@SecDecInternalNewline@#get_device_sector_90_order_0_n1_2_integrand,'
        target_FORM_code +=         '#@SecDecInternalNewline@##endif#@SecDecInternalNewline@#'
        target_FORM_code +=         'sector_90_order_0_n1_2_contour_deformation_polynomial,'
        target_FORM_code +=         'sector_90_order_0_n1_2_maximal_allowed_deformation_parameters}'
        target_FORM_code +=     '},true,#@SecDecInternalDblquote@#c#@SecDecInternalDblquote@#}'
        target_FORM_code +=   '},true,#@SecDecInternalDblquote@#b#@SecDecInternalDblquote@#}'
        target_FORM_code += '},true,#@SecDecInternalDblquote@#a#@SecDecInternalDblquote@#}'
