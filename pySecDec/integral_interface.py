...
class Qmc(CPPIntegrator):
    ...
    def __init__(self,integral_library,transform='korobov3',fitfunction='default',generatingvectors='default',epsrel=1e-2,epsabs=1e-7,maxeval=4611686018427387903,errormode='default',evaluateminn=0,
                      minn=10000,minm=0,maxnperpackage=0,maxmperpackage=0,cputhreads=None,cudablocks=0,cudathreadsperblock=0,verbosity=0,seed=0,devices=[],lattice_candidates=11,keep_lattices=False):
        ...
        self.c_integrator_ptr = self.c_lib.allocate_integrators_Qmc(epsrel,epsabs,maxeval,errormode_enum,evaluateminn,minn,
                                                                    ...
                                                                    lattice_candidates,keep_lattices
                                                                   )
        self._epsrel=epsrel
        self._epsabs=epsabs
        self._mineval=minn
...
class CudaQmc(object):
    ...
    '''
    def __init__(self,integral_library,transform='korobov3',fitfunction='default',generatingvectors='default',epsrel=1e-2,epsabs=1e-7,maxeval=4611686018427387903,errormode='default',evaluateminn=0,
                      minn=10000,minm=0,maxnperpackage=0,maxmperpackage=0,cputhreads=None,cudablocks=0,cudathreadsperblock=0,verbosity=0,seed=0,devices=[],lattice_candidates=11,keep_lattices=True):
...
class DistevalLibrary(object):
    ...
    def __call__(self,
            ...
            number_of_presamples=1e4, shifts=32, lattice_candidates=0, workers=None,
        ...
        output = subprocess.check_output([
            sys.executable, "-m", "pySecDec.deval",
                ...
                *(["--timeout", str(timeout)] if timeout is not None else []),
                ...
                "--shifts", str(shifts),
                "--lattice_candidates", str(lattice_candidates),
                *clusteropt,
