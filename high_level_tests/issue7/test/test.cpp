...
TEST_CASE( "check result qmc", "[INTEGRAL_NAME]" ) {
    ...
    SECTION("default integral transform") {
        ...
        const std::vector<INTEGRAL_NAME::real_t> real_parameters = { -0.5 };
        ...
        std::vector<INTEGRAL_NAME::nested_series_t<INTEGRAL_NAME::sum_t>> unwrapped_amplitudes =
            INTEGRAL_NAME::make_amplitudes(real_parameters, complex_parameters, "../issue7/issue7_data", integrator);
        ...
        // target result, obtained from analytic calculation
        ...
        (
            ...
            {
                 -3.1415926535897932385 + 0.0 * I, // eps ** -1
            },
