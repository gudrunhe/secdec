...
#define INTEGRAL_NAME mixed_packages
...
TEST_CASE( "check result", "[INTEGRAL_NAME]" ) {
    ...
    const std::vector<INTEGRAL_NAME::real_t> real_parameters = { 10, 2.0 };
    ...
    std::vector<INTEGRAL_NAME::nested_series_t<INTEGRAL_NAME::sum_t>> unwrapped_amplitudes =
        INTEGRAL_NAME::make_amplitudes(real_parameters, complex_parameters, "../mixed_packages/mixed_packages_data", integrator);
    ...
    (
        ...
        {
              5.000000000000000 +  0.0                * I, // eps ** -1
              10.63956085778167 +  7.024814731040726  * I, // eps ** 0
        },
