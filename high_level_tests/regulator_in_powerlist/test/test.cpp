...
constexpr INTEGRAL_NAME::complex_t I(0,1);
constexpr INTEGRAL_NAME::real_t EulerGamma = 0.5772156649015328606065120900824024310421593359399235988057672348848677267776646709369470632917467495L;
constexpr INTEGRAL_NAME::real_t pi = 3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068L;
