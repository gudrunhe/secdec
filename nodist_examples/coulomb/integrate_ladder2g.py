...
if __name__ == "__main__":
    ...
    # load c++ library
    box = IntegralLibrary('ladder_2g/ladder_2g_pylink.so')

    # choose integrator
#    box.use_Qmc(verbosity=2,minn=10**8,maxeval=1,transform='korobov3'')
    box.use_Qmc(verbosity=2,minn=10**7,maxeval=1,transform='baker')
...
#    s12, s23, s34, s45, s51, msq, mhsq = [2408664.483714835,-554153.4928655404,1496874.6133096598,735785.915792151,-517267.51076904044,256998.,41487.7]
    ...
    str_integral_without_prefactor, str_prefactor, str_integral_with_prefactor = box([s12,s23,s34,s45,s51,msq,mhsq],number_of_presamples=10**7,deformation_parameters_maximum=0.0001)
