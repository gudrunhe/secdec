...
# make_regions_args
name = 'bubble1L_expansion_by_regions_all_z',
integration_variables = ['x1','x2'],
regulators = ['eps'],
requested_orders = [0],
smallness_parameter = 'z',
polynomials_to_decompose = ['(x1 + x2)**(2*eps-2)','(-z*s*x1*x2 + z*msq*(x1+x2)**2 )**(-eps)'],
...
psd.code_writer.sum_package('bubble1L_expansion_by_regions_all_z',
