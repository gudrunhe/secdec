...
* {
  ...
  #redefine functionsToReplace "`functions',log,exp,SecDecInternalPow,SecDecInternalDenominator,sqrt"
  #If `contourDeformation'
...
* the c++ file yet.
  ...
  #redefine functionsToReplace "`functions',`decomposedPolynomialDerivatives',log,exp,SecDecInternalPow,SecDecInternalDenominator,sqrt"
  #If `contourDeformation'
