...
prefactor = '''
            ...
            ''',
polynomials_to_decompose = ['z3**(-1+4*alpha)', 'z2**(-1-4*eps+2*alpha)', 'z0**(1-4*eps)', '(1-z0) ** (1-4*eps)', '(1+z0) ** (1-4*eps)', '(2-z0**4)**(-1/2-eps)', '(1+z0**2)**(1-4*eps)', '(2-2*z0**4+z0**8)**(-1/2-eps)', '(z5)**(-1-2*eps)', '(2-z5**2)**(-1-eps)', '(z1)**(-1-8*eps)', '(2-z1**4)**(-1-2*eps)', '(2-2*z1**4+z1**8)**(-1-2*eps)', '(z4)**(1-4*eps)', '(1-z1**4*(-2+z1**4)*(2-2*z1**4+z1**8)*z4**4)**(-1/2-eps)', '(1-z1)**(1-4*eps)', '(1+z1)**(1-4*eps)', '(1+z1**2)**(1-4*eps)', '(1+z4**4)**(-3)', '(1+z2**2*(1-z1**4*(2-z1**4)*(2-2*z1**4+z1**8)*(1-z4**4)))**(2*(-1+eps))', '(1+z2**2-z1**4*(2-z1**4)*(2-2*z1**4+z1**8)*(1-z4**4))**(2*eps)', '(z1**2 - 4 * ((1-z1)*z4))**(-2)'],
